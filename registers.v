...
`define DEVICE_PROJ_NAME   "YLRCPU"
`define DEVICE_PROJ_DESC   "Skeleton Pipeline"
...
`define YLRCPU_BLOCK_ADDR_WIDTH         19
`define YLRCPU_REG_ADDR_WIDTH           4
...
`define YLRCPU_BLOCK_ADDR         19'h00004
...
`define YLRCPU_COMMAND_YLRCPU   4'h0
`define YLRCPU_ADDRESS_YLRCPU   4'h1
`define YLRCPU_IMEM             4'h2
`define YLRCPU_UPPER_DMEM       4'h3
`define YLRCPU_LOWER_DMEM       4'h4
`define YLRCPU_UPPER_DMEM_READ  4'h5
`define YLRCPU_LOWER_DMEM_READ  4'h6
